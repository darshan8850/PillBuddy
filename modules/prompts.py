OCR_PROMPT="""
You are a medicine OCR model. Extract the following details from the image. Include brand name and dosage if available. 
Don't add information that is not present in image.
"""
